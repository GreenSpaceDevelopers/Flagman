    ...
    return (
        <div className={`prefabricatedHouses ${isPageVisible ? 'visible' : ''}`}>
            ...
            <div className='prefabricatedHouses_block'>
                ...
                <p>
                    Модульные дома — одни из современных, быстро возводимых конструкций. Они теплые и отлично подходят,
                    как для постоянного проживания, так и в качестве сезонных домов для отдыха гостей или семьи в любых
            ...
            <div className='prefabricatedHouses_block'>
                <p>
                    Дом оснащен современными системами отопления вентиляции, управление умным домом и светодиодным
                    освещением, что значительно снижает потребление энергии по сравнению с традиционными домами.
                </p>
            ...
            <div className='prefabricatedHouses_block'>
                ...
                <p>
                    Идеально подходит для тех, у кого мало места для строительства. Они также могут служить садовым
                    домиком или загородным домиком для тех, кто любит проводить время на природе. Натуральные материалы,
                    используемые в производстве, и продуманные архитектурные решения позволят идеально вписаться в любую
                    среду
                </p>
            </div>
